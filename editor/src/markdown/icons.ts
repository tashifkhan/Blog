...
// ---------------------------------------------------------------------------
// Brand marks for known-site links
// ---------------------------------------------------------------------------

/**
 * Brand glyphs shown before the text of a link whose host matches a known
 * site, so a bare `github.com/user/repo` link reads as a branded chip.
 *
 * The filled glyphs are Simple Icons path data (CC0); the rest are hand-drawn
 * approximations in the stroke style of the named icons above. Keys are base
 * domains — `en.wikipedia.org` matches `wikipedia.org`, `www.github.com`
 * matches `github.com`.
 */

const BRAND_FILL = (body: string) =>
  `<svg class="md-brand-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">${body}</svg>`

const BRAND_STROKE = (body: string) =>
  `<svg class="md-brand-icon" ${STROKE} stroke-width="2" aria-hidden="true">${body}</svg>`

export const BRAND_ICONS: Record<string, string> = {
  'github.com': BRAND_FILL(
  ...
  'medium.com': BRAND_FILL(
    '<path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"/>',
  ),
  'npmjs.com': BRAND_FILL(
    '<path d="M0 7.334v8h6.666v1.332H12v-1.332h12v-8H0zm6.666 6.664H5.334v-4H3.999v4H1.334V8.667h5.332v5.331zm4.001 0H8.001V8.667h2.666v5.332zm8.001 0h-1.33v-4h-1.336v4h-1.335v-4h-1.33v4h-2.667V8.667h8v5.331zm-4.001-5.331h2.666v2.666h-2.666v-2.666z"/>',
  ),
  'reddit.com': BRAND_STROKE(
    '<circle cx="12" cy="14.5" r="6.5"/><circle cx="9.5" cy="13.5" r="1" fill="currentColor" stroke="none"/><circle cx="14.5" cy="13.5" r="1" fill="currentColor" stroke="none"/><path d="M10.5 16.8c1 .7 2 .7 3 0"/><circle cx="9" cy="8" r="1"/><circle cx="15" cy="8" r="1"/><path d="M9.5 9.5a2.5 2.5 0 0 1 5 0"/>',
  ),
  'wikipedia.org': BRAND_STROKE('<path d="M3 5l3.5 14L12 9.5 17.5 19 21 5"/>'),
  'stackoverflow.com': BRAND_STROKE(
    '<path d="M7.5 8.5 18 3.5l2 3-10.5 5z"/><path d="M6 12.5 16.5 8l1.5 3-10.5 4.5z"/><path d="M5 16.5 15.5 12.5l1 3.5-10.5 4z"/><path d="M5.5 20.5h13v2h-13z"/>',
  ),
  'discord.com': BRAND_STROKE(
    '<line x1="6" x2="10" y1="11" y2="11"/><line x1="8" x2="8" y1="9" y2="13"/><line x1="15" x2="15.01" y1="12" y2="12"/><line x1="18" x2="18.01" y1="10" y2="10"/><path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 1.414.586L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258-.007-.05-.011-.1-.017-.151A4 4 0 0 0 17.32 5z"/>',
  ),
  'tashif.codes': BRAND_STROKE(
    '<polyline points="4 17 10 11 4 5"/><line x1="12" x2="20" y1="19" y2="19"/>',
  ),
  'codetrace.xyz': BRAND_STROKE(
    '<polyline points="4 17 10 11 4 5"/><line x1="12" x2="20" y1="19" y2="19"/>',
  ),
}
